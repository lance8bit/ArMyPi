...
public class FetchActionActivate extends AsyncTask<Void, Void , Void> {
    ...
    public FetchActionActivate(AlarmPi alarmPi, String urlAccess, String actionQuery){
    ...
    protected void onPostExecute(Void unused) {
        ...
        try {
            ...
            refAlarms.child(alarmPi.getAlarmId()).child("active").setValue(true);
